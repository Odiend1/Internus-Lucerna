...
async function main(){
  ...
  async function gptResponseRealtime(userMessage, threadID=0) { 
    ...
    if (threadID == 0) {
        ...
        conversations[threadID].push({ role: 'system', content: 'Programs: [ { "program": "MITES", "description": "A 6-week summer residential program at MIT for rising seniors interested in STEM. Tuition-free and highly competitive." }, { "program": "NASA STEM", "description": "Work alongside NASA scientists and engineers on real missions. Open to high school juniors and seniors." }, { "program": "RSI - MIT", "description": "An elite 6-week summer program combining on-campus coursework and cutting-edge research with top scientists." }, { "program": "BoA Student Leaders", "description": "Paid summer internship with a nonprofit and a week-long leadership summit in Washington, D.C." }, { "program": "Stanford Collegiate", "description": "Academic enrichment programs across topics like AI, philosophy, and bioscience at Stanford University." }, { "program": "Garcia Research", "description": "Research in materials science and engineering, mentored by faculty at Stony Brook. Great for early STEM exposure." }, { "program": "Princeton Journalism", "description": "A prestigious 10-day summer program for high-achieving low-income high school juniors with an interest in journalism." }, { "program": "Girls Who Code", "description": "A 2-week virtual summer program that teaches high school girls the fundamentals of computer science." }, { "program": "US Senate Page", "description": "Spend a semester in Washington, D.C. as a Senate Page, assisting with legislative duties while taking academic courses." } ]'})
    }

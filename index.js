...
const serviceUUID = '19b10000e8f2537e4f6cd104768a1214';
const characteristicUUID = '19b10001e8f2537e4f6cd104768a1214';
...
//     let date = new Date();
//     var lastMeasurementTime = date.getTime();
//     if (error) {
...
//         return;
//       }
//       const pulseCharacteristic = characteristics[0];
//       pulseCharacteristic.subscribe((subError) => {
//         if (subError) {
//           console.error('Subscription error:', subError);
//           return;
//         }
//         pulseCharacteristic.on('data', (data) => {
//           const pulseValue = data.readInt32LE(0);
//           // console.log('Pulse Sensor Value:', pulseValue);
//           meanSignal *= 1.0 * entries++ / entries;
//           meanSignal = meanSignal * 0.5 + pulseValue * 0.5;
//           threshold = meanSignal + 300;

//           if(pulseValue > threshold && !surpassedThreshold){
//             surpassedThreshold = true;
//             let now = new Date();
//             bpm = bpm * 0.95 + (60000 / (now.getTime() - lastMeasurementTime)) * 0.05;
//             console.log((date.getTime() + " " + lastMeasurementTime));
//             lastMeasurementTime = now.getTime();
//             console.log("BPM: ", bpm);
//           }
//           else if(pulseValue < threshold && surpassedThreshold){
